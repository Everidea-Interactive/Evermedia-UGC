  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed left-1/2 top-1/2 z-[51] w-[min(calc(100vw-2rem),30rem)] -translate-x-1/2 -translate-y-1/2 rounded-[1.25rem] border border-border bg-card p-6 shadow-2xl outline-none"
